...
import { get_all_factory_project, methodGet, get_project_for_purchase } from '../../API_Service/API_Links';
...
export default function PurchaseTable() {
    ...
    const handleOpenEdit = (i) => {
        navigate('addquote', { state: { id: i.ProjectId, name : i.ProjectName } });
    }
