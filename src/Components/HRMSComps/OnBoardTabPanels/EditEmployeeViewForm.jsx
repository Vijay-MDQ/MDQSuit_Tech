...
export default function EditEmployeeViewForm(props) {
...

{
    EmployeeType === 'Factory Employee' ?
        <Grid container justifyContent='center' sx={{ textAlign: 'center' }}  spacing={4}  >
             <Grid item lg={6} xl={6}>
                ...
                <Box sx={{ pb: 5 ,textAlign:'left'}}><h5>BASIC INFOMRATION</h5></Box>
   ...
   <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 2 }} >
                    ...
                    />
                      ...
                      />
                        ...
                        <Grid item lg={12} sm={12} xl={12} xs={12} md={12} mt={3} >
                        <Box pb={3} sx={{textAlign:'left'}}><h5>ADDRESS INFOMRATION</h5></Box>
                         </Grid>
                       ...
                       <TextField  
                        ...
                        <Box pb={3} sx={{textAlign:'left'}}><h5>EDUCATION INFOMRATION</h5></Box>
                         </Grid>
 ...
 {/* (Financial Info) */}
                ...
                <Grid item lg={6} xl={6}>
               <Box  sx={{ border:"1px solid black" , px:4 , pb:3 ,pt:4 ,borderColor:'#d2cbcb;' , borderRadius:'4px',':hover': {  boxShadow:2},mt:5  }}>
                   ...
                   <h5>BANKING INFOMRATION</h5>
                    ...
                    <Grid container justifyContent='space-evenly' spacing={2}  >
                       ...
                       <Grid item lg={12} sm={12} xl={12} xs={12} md={12}>
                        ...
                        <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 2  }}  >
                         ...
                         <Grid item lg={12} sm={12} xl={12} xs={12} md={12} sx={{ py: 1  }}  >
                            ...
                            />
                               ...
                               <Grid item lg={12} sm={12} xl={12} xs={12} md={12} >
                        <Box sx={{textAlign:'left'}}><h5>PROOF DOCUMENTS</h5></Box>
                         </Grid>

                         <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1  }}  textAlign='left' >
                        <Typography color='#060606' fontWeight='bold' textAlign='left'>ADHAAR</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${AdhaarCard}`}
                        target="_blank"
                        style={{fontSize:13}}
                         >
                        {AdhaarCard}
                        ...
                        <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1  }}  >
                    <Typography color='#060606' fontWeight='bold' textAlign='left'>PAN</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${PANCard}`}
                        target="_blank"
                         style={{fontSize:13}}
                         >
                        {PANCard}
                            ...
                            <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1  }}  >
                           <Typography color='#060606' fontWeight='bold' textAlign='left'>DL</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${DL}`}
                        target="_blank"
                         style={{fontSize:13}}
                         >
                        {DL}
                        ...
                        <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1  }}  >
                           <Typography color='#060606' fontWeight='bold' textAlign='left'>Blood Report</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${BloodReport}`}
                        target="_blank"
                         style={{fontSize:13}}
                         >
                        {BloodReport}
                        ...
                        <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1 }}  >
                           <Typography color='#060606' fontWeight='bold' textAlign='left'>Educational Cert</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${EducationCert}`}
                        target="_blank"
                         style={{fontSize:13}}
                         >
                        {EducationCert}
                        ...
                        <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1  }}  >
                           <Typography color='#060606' fontWeight='bold' textAlign='left'>Employee CV</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${EmployeeCV}`}
                        target="_blank"
                         style={{fontSize:13}}
                         >
                        {EmployeeCV}
                        ...
                        <Box sx={{textAlign:'left'}}><h5>OFFER LETTER INFO</h5></Box>
                            ...
                            <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1  }}  >
                            <Typography color='#060606' fontWeight='bold' textAlign='left'>Insurance</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${Insurance}`}
                        target="_blank"
                         style={{fontSize:13}}
                         >
                        {Insurance}
                        ...
                        <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1 }}  >
                            <Typography color='#060606' fontWeight='bold' textAlign='left'>Experience Letter</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${ExpLetter}`}
                        target="_blank"
                         style={{fontSize:13}}
                         >
                        {ExpLetter}
                            ...
                            <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1  }}  >
                             <Typography color='#060606' fontWeight='bold' textAlign='left'>Relieving Letter</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${RelieveLetter}`}
                        target="_blank"
                         style={{fontSize:13}}
                         >
                        {RelieveLetter}
                          ...
                          <Grid item lg={6} sm={4} xl={4} xs={14} md={4} sx={{ py: 1  }}  >
                             <Typography color='#060606' fontWeight='bold' textAlign='left'>Offer Letter</Typography>
                        <Typography variant='subtitle1' color='#616e80' textAlign='left'>
                        <a
                        rel="noopener noreferrer"
                        href={`https://mdqualityapps.in/API/igreen_cms/UAT/profile/${OfferLetter}`}
                        target="_blank"
                         style={{fontSize:13}}
                         >
                        {OfferLetter}
