...
import { SystemSecurityUpdateGoodTwoTone, Visibility, VisibilityOff } from "@mui/icons-material";

export default function AddTab({setValue}) {
...

{
    EmployeeType === 'Factory Employee' ?
        <Grid container justifyContent='center' sx={{ textAlign: 'center' }}  spacing={4}  >
            ...
            <Box sx={{mt:5, px:2,  border:"1px solid black" ,borderColor:'#d2cbcb;' , borderRadius:'4px',':hover': {  boxShadow:2}, }}>
              ...
              >
                ...
                <Grid item lg={12} sm={12} xl={12} xs={14} md={12} sx={{ py: 2  }}>
                <Button
                sx={{ p: 2, color: 'white' }}
                fullWidth
                variant="contained"
              ...
              >
                ...
                <Box  sx={{ border:"1px solid black" , p:4 ,borderColor:'#d2cbcb;' , borderRadius:'4px',':hover': {  boxShadow:2}, mt:1 }} >
                <Box sx={{ pb: 2 ,textAlign:'left'}}><h5>BASIC INFOMRATION</h5></Box>
                 <Grid container justifyContent='space-evenly' spacing={2}  >
                    ...
                    />
                      ...
                      />
                        ...
                        <Box sx={{textAlign:'left'}}><h5>ADDRESS INFOMRATION</h5></Box>
                         </Grid>
                       ...
                       <TextField  
                        ...
                        <Box sx={{ pb: 1 ,textAlign:'left'}}><h5>EDUCATION INFOMRATION</h5></Box>
                         </Grid>
               ...
               <Box sx={{ pb: 3 ,textAlign:'left' }}>
                   <h5>BANKING INFOMRATION</h5>
                    ...
                    <Grid container justifyContent='space-evenly' spacing={2}  >
                       ...
                       <Grid item lg={12} sm={12} xl={12} xs={12} md={12} mt={5}>
                        <Box sx={{ pb: 1 ,textAlign:'left'}}><h5>PERSONAL INFOMRATION</h5></Box>
                         </Grid>
                        ...
                        <Grid item lg={12} sm={12} xl={12} xs={12} md={12} mt={3} >
                        <Box sx={{ pb: 1 ,textAlign:'left'}}><h5>OFFER LETTER INFO</h5></Box>
                         </Grid>
