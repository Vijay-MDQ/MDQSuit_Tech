...
import { get_all_maintenance_expense, get_all_purchases_expense, get_all_rental_expense } from "../../API_Service/API_Links";
...
export default function PurchasesTable() {
  ...
  const keys = Object.keys(data[0] || {}).filter((key) => key !== "purchaseId");
