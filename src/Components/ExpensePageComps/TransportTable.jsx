...
import { get_all_rental_expense, get_all_transport_expense, get_all_travel_expense } from "../../API_Service/API_Links";
...
export default function TransportTable() {
  ...
  const keys = Object.keys(data[0] || {}).filter((key) => key !== "transportId");
